...
const GreetLessonRoad: React.FC = () => {
  ...
  const [completedId, setCompletedId] = useState<number>(2);
        ...
        >
          ...
          >
            ...
            >
              <Icon
                ...
                cursor={"pointer"}
              />
              <Text fontSize={"16px"}>Section: Verb Conjugation</Text>
            </Box>
            <Text fontSize={isSmallerThan768 ? "20px" : "32px"}>
              Learn the funcdamental and important part of Japanse grammer of
              verbs.
            </Text>
          </Box>
          <Box display={"flex"} flexDir={"row"} w={"80%"}>
            ...
            <Box
              ...
              zIndex={2}
              onClick={() => {
                router.push("/lessons/verb-conjugation/1");
              }}
            >
          ...
          <Box display={"flex"} flexDir={"row"} w={"80%"}>
            ...
            <Box
              ...
              onClick={() => {
                ...
                router.push("/lessons/verb-conjugation/2");
              }}
            >
              <Box
                pos={"absolute"}
...
export default GreetLessonRoad;
